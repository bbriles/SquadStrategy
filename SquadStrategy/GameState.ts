module SimpleSquad {
    export class GameState extends Phaser.State {
        ...
        createTestEnemies() {
            this.enemies = [this.game.add.existing(new Unit(this.game, this.unitTypes["Black Knight 1"])),
                this.game.add.existing(new Unit(this.game, this.unitTypes["Bounty Hunter"])),
                this.game.add.existing(new Unit(this.game, this.unitTypes["Red Archer"]))];
